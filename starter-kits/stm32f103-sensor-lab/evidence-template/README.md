...
This directory defines what each Starter-F103 run should leave behind.

The first pass can be assembled manually or generated by `tools/run_starter_f103.ps1`.
