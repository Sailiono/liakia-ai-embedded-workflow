...
|---|---|---|---|
| Case B：BMP280 数据质量失败 | [case-b-bmp280-calibration/README.zh-CN.md](case-b-bmp280-calibration/README.zh-CN.md) | 完整替换 `liakia_lab_app.c` | 第一推荐 |
| Case A：I2C reset 后恢复失败 | [case-a-i2c-bus-stuck-reset/README.zh-CN.md](case-a-i2c-bus-stuck-reset/README.zh-CN.md) | 替换 `liakia_lab_port_stm32f103.c` | 硬件状态类 |
| Case D：Flash 配置持久化失败 | [case-d-flash-persistence-alignment/README.zh-CN.md](case-d-flash-persistence-alignment/README.zh-CN.md) | 配置持久化片段 | 状态持久化类 |
| Case C：UART DMA/IDLE 数据流失败 | [case-c-uart-dma-idle-race/README.zh-CN.md](case-c-uart-dma-idle-race/README.zh-CN.md) | DMA/IDLE 接收片段 | 高阶串口类 |
...
- Case A：练 reset 后状态证据和 I2C 恢复推理；
- Case D：练状态持久化、reset 后验证、原始记录检查和回归；
